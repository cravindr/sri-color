...
<div class="row">
    <div class="col-md-12 col-lg-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <div class="row">
                    <form class="form-horizontal form-label-left input_mask" method="post" enctype="multipart/form-data" action="<?php echo site_url('invoice/deliverychallansave');?>">
                        <div class="col-lg-6 col-md-6 col-xs-12">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Order No</label>
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input name="order_no" id="order_no" class="date-picker form-control col-md-7 col-xs-12" type="text" placeholder="Enter Order Number">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input name="ref_no" id="ref_no" class="date-picker form-control col-md-7 col-xs-12" type="text" placeholder="Enter Reference Number">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 col-md-12">
                                ...
                                <div class="form-group">
                                    <table id="productinv" class="table table-bordered">
                                        ...
                                        <tr>
                                            <th width="1%"></th>
                                            <th width="35%">Item Description &nbsp;<a href="" data-toggle="modal" data-target="#product_modal-add" title="New Product"><i class="fa fa-plus-circle" aria-hidden="true"></i></a></th>
                                            <th width="8%">HSN Code</th>
                                            <th width="8%">Bund Cont</th>
                                            <th width="8%">No Bund</th>
                                            <th width="8%">Hanking</th>
                                            <th width="7%">Qty</th>
                                            <th width="6%">Uom</th>
                                            <th width="8%">Price</th>
                                ...
                                <div class="form-group">
                                    <div class="pull-right">
                                        ...
                                        <button type="submit" id="btnprintdc" class="btn btn-success">Save and Print</button>
                                    </div>
                                </div>

        ...
        <tr>
            ...
            <td>
                ...
                if($v['ref_no'] == '')
                {
                    echo "<strong>"
                        .$v['prod_desc']." 
                      </strong><div style='font-size: 12px; display: inline;'>".$bh."</div>
                            <br><div class='desc-text'>".$v['dc_no']."-[".date('d-m-Y', strtotime($v['dc_date']))."]</div>";
                }
                else
                {
                    echo "<strong>"
                        .$v['prod_desc']." 
                            ...
                            <br><div class='desc-text'>".$v['dc_no']."-[".date('d-m-Y', strtotime($v['dc_date']))."]"."-[".$v['ref_no']."]</div>";
                }
